#!/usr/bin/python3
"""
Module définissant une classe Rectangle avec affichage string.
...
le périmètre et afficher le rectangle avec des caractères #.
"""
...
class Rectangle:
    ...
    une hauteur, et offre des méthodes pour calculer l'aire, le périmètre
    et l'affichage.
